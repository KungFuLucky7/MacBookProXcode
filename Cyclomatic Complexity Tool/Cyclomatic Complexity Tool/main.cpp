...
//
//  Created by Terry Chun Wong on 4/1/14.
...
int LN, V, LLOC, PLOC, NPU, NSC, NEQ, Nif, Nswitch, Nwhile, Nfor;
...
int main()
{
    ...
    LN = 0;
    V = LLOC = PLOC = NPU = NSC = NEQ = Nif = Nswitch = Nwhile = Nfor =0;
    string filename;
    
    printf("Working Dir: %s\n", getcwd(NULL, 0));
    cout << "Please enter the filename for analysis from the Cyclomatic Complexity Tool:\n";
    cin >> filename;
